...
local function updateMaterial(dt)
  ...
  local swF = getSwitchableMaterial(matVisible, "body_roof_ragtop_fabric")
  local swA = getSwitchableMaterial(matHidden,  "body_roof_ragtop_fabric.a")
  local swB = getSwitchableMaterial(matHidden,  "body_roof_ragtop_fabric.b")
  
  local sw1 = getSwitchableMaterial(matHidden,  "body_roof_ragtop_fabric.1")
  local sw2 = getSwitchableMaterial(matHidden,  "body_roof_ragtop_fabric.2")
